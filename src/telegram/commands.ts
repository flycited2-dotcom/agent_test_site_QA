...
export function helpText(): string {
  return [
    ...
    '/запуск enterprise — запустить максимально глубокий аудит уровня большой QA-команды',
    '/сайт https://example.com — переключить сайт',
    '/профиль авто|лендинг|сайт|каталог|магазин — выбрать профиль',
    '/глубина smoke|critical|full|enterprise — режим расписания',
    '/режим smoke|critical|full|enterprise — то же самое',
